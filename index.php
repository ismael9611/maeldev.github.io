...
<body>
    <header>
        <div class="center">
            <div class="logo left">Mael Devs</div>
    ...
    <section class="inicio">
        <img class="banner_principal" src="assets/img/banner_principal.png" alt="">
    </section><!---inicio--->
    ...
    <section class="sobre">
        ...
        <div class="w50 right">
            <img class="bg-autor" src="assets/img/bg-autor.jpg" alt="">
        </div><!---w50--->
         <div class="clear"></div>
        </div><!---center--->
    </section><!---sobre--->
    ...
    <section class="especialidades">
        <div class="center">
            ...
            <div class="box-especialidades w25 left">
                <h3><i class="i-php fa-brands fa-php"></i></i></h3>
                <h4>PHP</h4>
            ...
            <div class="box-especialidades w25 left">
                <h3><i class="i-html fa-solid fa-file-code"></i></h3>
                <h4>HTML5</h4>
            ...
            <div class="box-especialidades w25 left">
                <h3><i class="i-css fa-brands fa-css"></i></h3>
                <h4>CSS</h4>
            ...
            <div class="box-especialidades w25 left">
                <h3><i class="i-js fa-brands fa-js"></i></h3>
                <h4>JS</h4>
